...
class ReferenceListFieldWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        refListNameLabel = Gtk.Label("Reference List Name")
        refListNameLabel.set_justify(Gtk.Justification.CENTER)
        vbox_top.pack_start(refListNameLabel, True, True, 5)

        # Reference List Name Entry 
        refListNameEntry = Gtk.Entry()
        vbox_top.pack_start(refListNameEntry, True, True, 5)
